...
using Util::Message;
  ...
  enum Type { __BOOL = 0, __INT, __FLOAT, STRING, ENUM };
  ...
  public:
            ...
            Value value, bool printHex)
    {
      ...
      _type = type;
      _key = _strdup (key);
      _description = _strdup (description);
                           ...
                           const char *description)
  {
    ...
    Option *option = new Option (Type::__BOOL, key, description, NULL, value, false);
    map.put (option);
  }
                          ...
                          const char *description, bool printHex)
  {
    ...
    Option *option = new Option (Type::__INT, key, description, NULL, value, printHex);
    map.put (option);
  }
                            ...
                            const char *description)
  {
    ...
    Option *option = new Option (Type::__FLOAT, key, description, NULL, value, false);
    map.put (option);
  }
  ...
  {
    Value value;
    value._string = (defaultValue == NULL) ? NULL : _strdup (defaultValue);
  ...
  {
    Option *option = map.getAlways (key, Type::__BOOL);
  ...
  {
    Option *option = map.getAlways (key, Type::__INT);
  ...
  {
    Option *option = map.getAlways (key, Type::__FLOAT);
  ...
  {
    Option *option = map.getAlways (key, Type::STRING);
    ...
    {
      return _strdup (option->_value._string);
    }
  }
  ...
  {
    Option *option = map.getAlways (key, Type::ENUM);
  ...
  parseInt (const char *s, int64 & val)
  {
    ...
    c = sscanf_s (s, "%lld%n", &val, &n);
    if (c == 1 && s[n] == '\0')
    {
      return;
    }
    c = sscanf_s (s, "%llx%n", &val, &n);
    if (c == 1 && s[n] == '\0')
    {
      return;
    }
  ...
  parseValue (Type type, const char *const *enumValues, const char *s)
  {
    ...
    case Type::__FLOAT:
      ...
      break;
    case Type::STRING:
      value._string = _strdup (val.text ());
      break;
    case Type::ENUM:
