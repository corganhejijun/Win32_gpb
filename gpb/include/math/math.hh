 ...
 */
#define MATH__MATH__DEFINE_CONSTANTS 1
 ...
 */
#define MATH__MATH__DEFINE_ACOSH 1
#define MATH__MATH__DEFINE_ASINH 1
#define MATH__MATH__DEFINE_ATANH 1
#define MATH__MATH__DEFINE_ROUND 1
